...
map_pgh +
  ...
  labs(title = "Hour:",
       subtitle = "Crashes in Allegheny County 2014-2017") +
  theme_void() -> p
gganimate(p, interval = .5, title_frame = TRUE, ani.width=1600, ani.height=800, ani.res = 1000)

gganimate(p, interval = .5, title_frame = TRUE, ani.width=1600, ani.height=800, ani.res = 1000, "output.gif")
```